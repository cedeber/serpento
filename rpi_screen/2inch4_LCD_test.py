...
try:
    ...
    image1 = Image.new("RGB", (disp.width, disp.height ), "#242526")
    ...
    Font1 = ImageFont.truetype("./assets/Font01.ttf",25)
    Font2 = ImageFont.truetype("./assets/Font01.ttf",35)
    Font3 = ImageFont.truetype("./assets/Font02.ttf",32)
    ...
    image = Image.open('./assets/LCD_2inch4.jpg')	
